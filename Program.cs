...
// while(error)
// {
//     System.Console.Write("Введите  число номер 1: ");
//     m = int.Parse(Console.ReadLine());
//     System.Console.Write("Введите  число номер 2: ");
//     n = int.Parse(Console.ReadLine());
//     if(m < 0 || n < 0)
//     {
//         System.Console.WriteLine("Неверно !!! Оба числа должны быть положительными(+)!");
//     }
//     else
//     {
//         error = false;
